...
<div class="container-data">
    <span class="span-label">EDIT ASET KANTOR KEPALA DESA BEJI
</span>
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="update_aset.php" method="post" onsubmit="return validateForm()">
                        <div class="form-grup">
                        ...
                        <div class="form-grup mt-2">
                            <label><strong>JUMLAH PENAMBAHAN : </strong></label>
                        ...
                        <div class="form-grup mt-2">
                            ...
                            <input type="number" name="harga" value="<?php echo $row['harga'] ?>" placeholder="Masukkan Harga Sewa " class="form-control required">
                        </div>
                        <div class="form-grup mt-2">
